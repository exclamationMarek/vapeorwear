...
* On-Off switch (drains < 3µA when off)
...
2. 22uF (bypass for buck)
3. 22uF (output for buck)
4. 22uF (optional, more output for buck)
5. 1uF (bypass for protection IC)

## ROW 5: Resistors
1. 5.1k	(charge current set resistor. 5.1k->196mA, 2.2k->450mA, 10k->100mA)
